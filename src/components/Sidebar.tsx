...
const Sidebar = ({
  ...
  const { isTrialing, trialDaysRemaining, isSuperAdmin, isAdmin } = useOrganization();
  ...
  return (
    <>
      ...
      <nav className="sidebar-nav">
        ...
        {isSuperAdmin && (
          <NavLink to="/seo-iq" className="nav-item" title="SEO IQ" onClick={onCloseMobile}>
            <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            <span className="nav-label">SEO IQ</span>
          </NavLink>
        )}

        <NavLink to="/integrations" className="nav-item" title="Integrations" onClick={onCloseMobile}>
          <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <NavLink to="/swipe-library" className="nav-item" title="Swipe Library" onClick={onCloseMobile}>
          ...
          <span className="nav-label">Swipe Library</span>
        </NavLink>

        <NavLink to="/inspiration" className="nav-item" title="Inspiration Library" onClick={onCloseMobile}>
          <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="11" cy="11" r="7"/>
            <path d="M21 21l-4.35-4.35"/>
          </svg>
          <span className="nav-label">Inspiration</span>
        </NavLink>

        <NavLink to="/showcase" className="nav-item" title="Showcase Library" onClick={onCloseMobile}>
          <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {isAdmin && (
          <NavLink to="/reports" className="nav-item" title="Reports" onClick={onCloseMobile}>
            <svg className="nav-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">

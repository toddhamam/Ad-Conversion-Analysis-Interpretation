...
// Facebook Login for Business configuration ID — defines permissions and token type.
// Created in Meta Developer Dashboard → Facebook Login for Business → Configurations.
...
export default async function handler(req: VercelRequest, res: VercelResponse) {
  ...
  // Uses config_id instead of scope — the configuration defines permissions and token type
